 ...
 * freed via hment_free() after doing aarch64_hm_exit().
 */
 ...
 */
extern void aarch64_hm_enter(page_t *);
extern void aarch64_hm_exit(page_t *);
extern int aarch64_hm_held(page_t *pp);
