 ...
 *
 * This file describes the contents of the aarch64 HAT data structures.
 */
#include <sys/types.h>
...
struct hat {
	...
	uint64_t	hat_asid_gen[NCPU];	/* XXXAARCH64 */
	uint32_t	hat_asid[NCPU];		/* XXXAARCH64 */
};
...
struct hatstats {
	...
	ulong_t hs_hat_normal64;	/* XXXAARCH64: but why? */
};
...
/*
 * aarch64 specific routines for use online in setup or armsbsa/vm files
 */
...
extern void hat_pte_unmap(htable_t *ht, uint_t entry, uint_t flags,
	aarch64pte_t old_pte, void *pte_ptr, boolean_t tlb);
...
/*
 * XXXAARCH64: pretty sure this range stuff is YAGNI - will see later.
 */
...
extern void mmu_flush_tlb(flush_tlb_type_t, tlb_range_t *);	/* XXXAARCH64: implement? */
extern void mmu_flush_tlb_kpage(uintptr_t);
extern void mmu_flush_tlb_page(uintptr_t);	/* XXXAARCH64: implement? */
...
/*
 * The following are specific to the original port, but seem pretty fundamantal.
 */
...
extern int hat_page_falt(hat_t *hat, caddr_t vaddr);
