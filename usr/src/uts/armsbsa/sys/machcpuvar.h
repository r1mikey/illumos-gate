...
struct machcpu {
	...
	/* XXXAARCH64: this block must all go */
...
#define	cpu_ppaddr_mutex cpu_m.mcpu_ppaddr_mutex	/* must go */
#define	cpu_caddr1 cpu_m.mcpu_caddr1			/* must go */
#define	cpu_caddr2 cpu_m.mcpu_caddr2			/* must go */
#define	cpu_caddr1pte cpu_m.mcpu_caddr1pte		/* must go */
#define	cpu_caddr2pte cpu_m.mcpu_caddr2pte		/* must go */
