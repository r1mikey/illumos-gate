...
/*
 * XXXAARCH64: where/how/what is this used?
 *
 * uts/common/io/consconfig_dacf.c
 *
 * sparc sets this from an extern polled_debug
 */
int
 ...
 * XXXAARCH64: where/how/what is this used?
 *
 * Unused outside of being used internally within the sparc file.
 */
int
 ...
 *
 * XXXAARCH64: very ISA-specific (as in the bus) and wrong for aarch64
 ...
 *
 * XXXAARCH64: we have no VGA, this needs thought.
 */
char *
plat_fbpath(void)
{
...
/*
 * XXXAARCH64: this should return the diagnostics port
 */
char *
plat_diagpath(void)
{
