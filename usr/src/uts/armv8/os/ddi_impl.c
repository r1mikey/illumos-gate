    ...
    ddi_intr_handle_impl_t *hdlp)
{
	...
	VERIFY(ddi_prop_exists(DDI_DEV_T_ANY, msi_dip,
	    DDI_PROP_DONTPASS, OBP_MSI_CONTROLLER));

	/*
	 * Use the PCI Requester ID as the DeviceID (identity mapping).
	 * For non-PCI devices, this will fail and we return NULL.
	 */
 ...
 * Called from pci_common_intr_ops() after PCI-level teardown.
 */
int
