 ...
 * Initialisation.
 *
 * Called from startup_modules after syspic_init.  On failure, logs
 * a message and leaves ffa_state.fs_available as B_FALSE.  Consumers
 * check ffa_available before calling.
 */
void
ffa_init(void)
{
