 ...
 * phys_hi cell:      xxxxxxxx xxxxxxxx xxxxxBxx TSxxxTTT
 * phys_hi(memory):   xxxxxxxx xxxxxxxx wxxxxBcc --xxx000
 * phys_hi(io):       xxxxxxxx xxxxxxxx sdxxxBaa --xxx001
 ...
 * B          is 1 if the memory is 64-bit
...
#define	ACPIDEV_REG_MEM_COHERENT_PF	0x00000300	/* Prefetchable */
#define	ACPIDEV_REG_MEM_64BIT		0x00000400
...
struct acpidev_resource_handle {
	...
	int				acpidev_irqf[ACPIDEV_RES_IRQ_MAX];
