...
/*
 * Collaborative Processor Performance Control (CPPC) - ACPI 6.5 S8.4.7.
 *
 ...
 *   - FFH (0x7F): Functional Fixed Hardware.  On arm64, per DEN0048D:
 ...
 * time.  HW_ALL is the production-tested path.
 */
 ...
 * register(s) via the correct transport (PCC, SystemMemory).
 *
 * Returns DDI_SUCCESS or DDI_FAILURE.
 */
