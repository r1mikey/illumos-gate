...
/* #address-cells and #size-cells for the ACPI nexus */
#define	ACPIDEV_ROOTNEX_ADDRESS_CELLS	3
#define	ACPIDEV_ROOTNEX_SIZE_CELLS	2

/*
 * #address-cells and #size-cells for the root nexus and
 * fixed nodes (GIC etc.) on ACPI systems
 */
#define	ACPIDEV_ROOT_ADDRESS_CELLS	2
#define	ACPIDEV_ROOT_SIZE_CELLS		2
...
#endif
#if defined(__aarch64__)
#define	ACPIDEV_PROP_NAME_MPIDR		"mpidr"
#endif
