...
/* #address-cells and #size-cells for the ACPI root nexus */
#define	ACPIDEV_ROOTNEX_ADDRESS_CELLS	3
#define	ACPIDEV_ROOTNEX_SIZE_CELLS	2

/* #address-cells and #size-cells for the root nexus on ACPI systems */
...
#endif
#if defined(__aarch64__)
#define	ACPIDEV_PROP_NAME_LOCALAPIC_ID	"mpidr"
#endif
