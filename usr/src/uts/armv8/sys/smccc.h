...
/*
 * SMCCC_ARCH_SOC_ID type values (S7.4).
 */
...
/*
 * Attributes returned by SMCCC_ARCH_CLEAN_INV_MEMREGION_ATTRIBUTES (S7.11).
 */
...
/*
 * SMCCC_ARCH_CLEAN_INV_MEMREGION flags (S7.10).
 */
