 ...
 * Design:
 *
 *   pg_plat_set_pptt() is called from mlsetup() before pg_cpu_bootstrap(),
 ...
 *
 * Called from pg_plat_set_pptt() during early boot, before kmem is available.
 ...
 */
void
pg_plat_set_pptt(uint64_t pptt_pa)
{
