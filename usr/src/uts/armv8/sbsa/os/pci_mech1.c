...
pci_mech1_getb(int bus, int device, int function, int reg)
{
	...
	return (pci_cfgacc_get8(NULL, PCI_GETBDF(bus, device, function), reg));
}
...
pci_mech1_getw(int bus, int device, int function, int reg)
{
	...
	return (pci_cfgacc_get16(NULL, PCI_GETBDF(bus, device, function), reg));
}
...
pci_mech1_getl(int bus, int device, int function, int reg)
{
	...
	return (pci_cfgacc_get32(NULL, PCI_GETBDF(bus, device, function), reg));
}
...
pci_mech1_putb(int bus, int device, int function, int reg, uint8_t val)
{
	...
	pci_cfgacc_put8(NULL, PCI_GETBDF(bus, device, function), reg, val);
}
...
pci_mech1_putw(int bus, int device, int function, int reg, uint16_t val)
{
	...
	pci_cfgacc_put16(NULL, PCI_GETBDF(bus, device, function), reg, val);
}
...
pci_mech1_putl(int bus, int device, int function, int reg, uint32_t val)
{
	...
	pci_cfgacc_put32(NULL, PCI_GETBDF(bus, device, function), reg, val);
}
