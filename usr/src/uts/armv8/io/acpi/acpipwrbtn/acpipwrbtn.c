 ...
 */
static hrtime_t	acpipwrbtn_abort_interval = 1500000000LL;	/* 1.5 sec */
static int	acpipwrbtn_abort_presses = 3;
static int	acpipwrbtn_abort_enable = 1;
static int	acpipwrbtn_enable = 1;
...
/*
 * ACPI notify handler — called by ACPICA when Notify(PNP0C0C, 0x80)
 * is evaluated in AML.
 */
/*ARGSUSED*/
static void
...
/*ARGSUSED*/
static int
acpipwrbtn_getinfo(dev_info_t *dip, ddi_info_cmd_t infocmd, void *arg,
    void **result)
{
	acpipwrbtn_softstate_t *sp;
...
/*ARGSUSED*/
static int
acpipwrbtn_open(dev_t *devp, int openflags, int otyp, cred_t *credp)
{
	acpipwrbtn_softstate_t *sp;
	int clone;
...
/*ARGSUSED*/
static int
acpipwrbtn_close(dev_t dev, int openflags, int otyp, cred_t *credp)
{
	acpipwrbtn_softstate_t *sp;
	int clone;
...
/*ARGSUSED*/
static int
acpipwrbtn_ioctl(dev_t dev, int cmd, intptr_t arg, int mode, cred_t *cred_p,
    int *rval_p)
{
	acpipwrbtn_softstate_t *sp;
	int clone;
...
/*ARGSUSED*/
static int
acpipwrbtn_chpoll(dev_t dev, short events, int anyyet,
