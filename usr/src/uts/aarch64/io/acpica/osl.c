...
/* XXXAARCH64: porting hack */
#if !defined(MAX_IO_APIC)
#define	MAX_IO_APIC	32
#endif
...
{
	/* XXXAARCH64: not applicable in aarch64 and reduced hardware */
#if 0
	struct io_perm *p;
...
{
	/* XXXAARCH64: AcpiHwRegisterWrite not in reduced hardware */
#if 0
