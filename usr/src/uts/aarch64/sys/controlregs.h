...
#define	TCR_IPS_32BIT	TCR_IPS_4G
#define	TCR_IPS_64G	(1ul << TCR_IPS_SHIFT)
#define	TCR_IPS_36BIT	TCR_IPS_64G
#define	TCR_IPS_1T	(2ul << TCR_IPS_SHIFT)
#define	TCR_IPS_40BIT	TCR_IPS_1T
#define	TCR_IPS_4T	(3ul << TCR_IPS_SHIFT)
#define	TCR_IPS_42BIT	TCR_IPS_4T
#define	TCR_IPS_16T	(4ul << TCR_IPS_SHIFT)
#define	TCR_IPS_44BIT	TCR_IPS_16T
#define	TCR_IPS_256T	(5ul << TCR_IPS_SHIFT)
#define	TCR_IPS_48BIT	TCR_IPS_256T
#define	TCR_IPS_4PB	(6ul << TCR_IPS_SHIFT)
#define	TCR_IPS_52BIT	TCR_IPS_4PB
#define	TCR_IPS_64PB	(7ul << TCR_IPS_SHIFT)
#define	TCR_IPS_56BIT	TCR_IPS_64PB
