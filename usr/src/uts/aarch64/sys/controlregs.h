...
#define	CTR_DLINE_MASK			(0xful << CTR_DLINE_SHIFT)
#define	CTR_DLINE_VAL(x)		((x) & CTR_DLINE_MASK)
#define	CTR_DLINE_SIZE(x)		(4 << (CTR_DLINE_VAL((x)) >> CTR_DLINE_SHIFT))

#define	CTR_ILINE_SHIFT			0
#define	CTR_ILINE_MASK			(0xful << CTR_ILINE_SHIFT)
#define	CTR_ILINE_VAL(x)		((x) & CTR_ILINE_MASK)
#define	CTR_ILINE_SIZE(x)		(4 << (CTR_ILINE_VAL((x)) >> CTR_ILINE_SHIFT))

#define	CTR_TO_DATA_LINESIZE(ctr)	CTR_DLINE_SIZE((ctr))
#define	CTR_TO_INST_LINESIZE(ctr)	CTR_ILINE_SIZE((ctr))
...
#define	ID_AA64PFR0_GIC_BITS	(0x4)
