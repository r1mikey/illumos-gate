...
{ (void)__atomic_add_fetch(target, 1, __ATOMIC_ACQ_REL); }
...
{ (void)__atomic_sub_fetch(target, 1, __ATOMIC_ACQ_REL); }
...
{ (void)__atomic_add_fetch(target, value, __ATOMIC_ACQ_REL); }
...
{ (void)__atomic_add_fetch((caddr_t *)target, value, __ATOMIC_ACQ_REL); }
...
{ (void)__atomic_or_fetch(target, bits, __ATOMIC_ACQ_REL); }
...
{ (void)__atomic_and_fetch(target, bits, __ATOMIC_ACQ_REL); }
...
{ return __atomic_add_fetch((caddr_t *)target, value, __ATOMIC_ACQ_REL); }
...
{ return __atomic_or_fetch(target, value, __ATOMIC_ACQ_REL); }
...
{ return __atomic_and_fetch(target, value, __ATOMIC_ACQ_REL); }
...
{ { (void)__atomic_compare_exchange_n(target, &cmp, newval,
    0, __ATOMIC_ACQ_REL, __ATOMIC_ACQUIRE); return cmp; } }
...
{ return __atomic_exchange_n(target, newval, __ATOMIC_ACQ_REL); }
...
{ return __atomic_exchange_n((void **)target, newval, __ATOMIC_ACQ_REL); }
...
atomic_set_long_excl(volatile ulong_t *target, uint_t value)
{
	...
	return (__atomic_fetch_or(target, bit, __ATOMIC_ACQ_REL) & bit ? -1: 0);
}
...
atomic_clear_long_excl(volatile ulong_t *target, uint_t value)
{
	...
	return (__atomic_fetch_and(
	    target, ~bit, __ATOMIC_ACQ_REL) & bit ? 0: -1);
}
