...
export i386_SHADOW_CCS=gcc14,/usr/gcc/14/bin/gcc,gnu
export i386_SHADOW_CCCS=gcc14,/usr/gcc/14/bin/g++,gnu
...
export aarch64_SHADOW_CCS=gcc14,/usr/gcc/14/bin/gcc,gnu
export aarch64_SHADOW_CCCS=gcc14,/usr/gcc/14/bin/g++,gnu
