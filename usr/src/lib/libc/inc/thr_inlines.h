...
__curthread(void)
{
	...
	/* XXXAARCH64: does this really need to be different? */
...
/*
 * XXXAARCH64: surely this could be implemented using the virtual counter?
...
set_lock_byte(volatile uint8_t *__lockp)
{
	...
	__asm__ __volatile__(
	    ...
	    : "=r" (__value), "+m" (*__lockp));
#elif defined(__aarch64__)
	/* XXXAARCH64: this needs to be implemented properly */
...
/* XXXAARCH64: this could just be implemented rather than hacked */
#if !defined(__aarch64__)
