...
typedef enum arm_cond_code {
	ARM_COND_EQ,	/* 0b0000 Equal */
	ARM_COND_NE,	/* 0b0001 Not Equal */
	ARM_COND_CSHS,	/* 0b0010 Carry set/unsigned higher or same */
	ARM_COND_CCLO,	/* 0b0011 Carry clear/unsigned lower */
	ARM_COND_MI,	/* 0b0100 Minus/negative */
	ARM_COND_PL,	/* 0b0101 Plus/positive or zero */
	ARM_COND_VS,	/* 0b0110 Overflow */
	ARM_COND_VC,	/* 0b0111 No overflow */
	ARM_COND_HI,	/* 0b1000 Unsigned higher */
	ARM_COND_LS,	/* 0b1001 Unsigned lower or same */
	ARM_COND_GE,	/* 0b1010 Signed greater than or equal */
	ARM_COND_LT,	/* 0b1011 Signed less than */
	ARM_COND_GT,	/* 0b1100 Signed greater than */
	ARM_COND_LE,	/* 0b1101 Signed less than or equal */
	ARM_COND_AL,	/* 0b1110 AL - Always (unconditional) */
	ARM_COND_NACC	/* 0b0000 Not a condition code */
} arm_cond_code_t;
...
a32_dis(dis_handle_t *dhp, uint32_t in, char *buf, size_t buflen)
{
	...
	op0 = (in & ARM_L1_DEC_MASK) >> ARM_L1_DEC_SHIFT;
	...
	case 0x1:
		/*
		 * In op0 group 0b001 there are a few ways to tell things apart.
	...
	case 0x7:
		/*
		 * In op0 group 0b111 you can determine the three groups using
		 * the following logic. If the next bit after the op0 group (bit
