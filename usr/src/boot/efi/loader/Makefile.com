...
DPADD=		$(DPLIBFICL) $(DPLIBACPIUART) $(DPLIBFDTUART) \
		$(DPLIBMMIOUART) $(DPLIBACPICA) $(DPLIBFDTUTIL) $(DPLIBFDT) \
		$(DPLIBEFI) $(DPLIBSA) $(LDSCRIPT)
LDADD=		$(LIBFICL) $(LIBACPIUART) $(LIBFDTUART) \
		$(LIBMMIOUART) $(LIBACPICA) $(LIBFDTUTIL) $(LIBFDT) \
		$(LIBEFI) $(LIBSA)
